...
<script>
import {getStoreByUser,getMenuList,addMenu,getMenuById,editMenu,delMenuById,getMenuTypeList}from '../../api/index'
...
export default {
  ...
  methods:{
    ...
    /**计算折后价格 */
    editDiscount(event){
      this.food.priceAfterDiscount = this.food.menuPrice * this.food.menuDiscount / 100
    }
  }
};
</script>
